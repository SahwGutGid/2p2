...
export const SKILLS: SkillNode[] = [
  ...
  // ─── BONUS (10 nodes) ──────────────────────────────────────────
  {
    ...
    short: "Yield Boost",
    description: "Increases all investment profits by 5% per level through compound growth strategies.",
  ...
  },
  {
    ...
    short: "Duration Opt",
    description: "Reduces investment package duration by 3% per level through efficient capital deployment.",
  ...
  },
  {
    ...
    short: "Passive Boost",
    description: "Increases passive yield output by 15% per level through optimized income streams.",
  ...
  },
  {
    ...
    short: "Synergy",
    description: "Increases profit by 4% per additional invested slot through diversified portfolio optimization.",
  ...
  },
  {
    ...
    short: "Wealth Amp",
    description: "Multiplies all profit bonuses by 1.5x through advanced wealth management strategies.",
  ...
  },
  {
    ...
    short: "Dividends",
    description: "Adds a 3% dividend bonus per level to each investment completion.",
  ...
  },
  {
    ...
    short: "Hedge Fund",
    description: "Increases passive income by 25% through professional hedge fund strategies.",
  ...
  },
  {
    ...
    short: "Capital Opt",
    description: "Increases all profits by 15% through advanced capital allocation strategies.",
  ...
  // ─── ENDGAME (Legend-only chain in the Money column) ──────────
  {
    ...
    name: "Market Dominance",
    short: "Market Dom",
    description: "Triples all investment profits through complete market control and dominance.",
  ...
  },
  {
    ...
    short: "Cost Mastery",
    description: "Reduces all investment costs by 50% through advanced cost optimization strategies.",
    effect: () => "Pkg costs −50%",
    path: "money", row: 13,
  ...
  },
  {
    ...
    short: "Passive Max",
    description: "Quintuples passive income and savings interest through maximum yield optimization.",
    effect: () => "Passive ×5",
    path: "money", row: 14,
  ...
  },
  {
    ...
    short: "Ultimate",
    description: "Reduces all upgrade costs by 75% through complete system optimization and mastery.",
