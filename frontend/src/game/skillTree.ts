...
export const LEGACY_UPGRADES: LegacyUpgrade[] = [
  {
    ...
    description: "+30% investment profits · +20% investment speed · Strong foundation for endgame progression",
    cost: 10,
    effect: "+30% profit, +20% speed",
    tint: "#F59E0B",
    isFinal: false,
  },
  {
  ...
  },
  {
    ...
    description: `Generate ${formatCurrency(500000)}/h passive income · +15% all profits · Unlock empire reputation bonuses`,
    cost: 400,
    effect: "+$500K/h passive, +15% profit",
    tint: "#7F1D1D",
    isFinal: false,
  },
  {
  ...
  },
  {
    ...
    description: "+50% all profits · +30% investment speed · Unlock ultimate business network bonuses",
    cost: 2500,
    effect: "+50% profit, +30% speed",
    tint: "#FBBF24",
    isFinal: false,
  },
  {
    ...
    description: "FINAL ACHIEVEMENT · +100% all profits · Legendary golden theme · Ultimate Investor title · Game completion celebration",
    cost: 10000,
    effect: "+100% profit, legendary theme, title",
    tint: "#E5E7EB",
    isFinal: true,
  },
];
...
export const SKILLS: SkillNode[] = [
  ...
  {
    id: "auto-reinvest",
    name: "Automated Reinvestment",
    short: "Auto-Reinvest",
    description: "Automatically reinvests completed slots with the selected package when funds are available.",
  ...
  {
    id: "auto-fill",
    name: "Portfolio Autofill",
    short: "Autofill",
    description: "Fills all empty portfolio slots with the selected package when returning to the app.",
  ...
  {
    id: "auto-accel",
    name: "Automated Acceleration",
    short: "Auto-Accel",
    description: "Automatically activates acceleration at 33%, 66%, and 100% of manual strength per level.",
  ...
  {
    id: "offline-loop",
    name: "24/7 Trading System",
    short: "24/7 Trading",
    description: "Continues automated reinvestment while the app is closed, up to 8 hours of offline progress.",
  ...
  },
  {
    ...
    short: "Smart Select",
    description: "Automatically selects the highest-tier affordable package for each portfolio slot.",
  ...
  {
    id: "auto-upgrade",
    name: "Automated Skill Acquisition",
    short: "Auto-Skills",
    description: "Automatically purchases the next affordable skill tree upgrade when Prestige Points are available.",
  ...
  },
  {
    ...
    short: "HFT Processing",
    description: "Investment completions process 25% faster, reducing queue delays and improving throughput.",
  ...
  },
  {
    ...
    short: "Algo Optimize",
    description: "Improves automated package selection efficiency by 15% through advanced algorithms.",
  ...
  },
  {
    ...
    short: "Adv. Automation",
    description: "Increases the speed of all automation systems by 20% through advanced technology.",
  ...
  },
  {
    ...
    short: "Autonomous",
    description: "Increases automated reinvestment frequency by 30% when portfolio slots are available.",
  ...
  // ─── BONUS (10 nodes) ──────────────────────────────────────────
  {
    ...
    short: "Yield Boost",
    description: "Increases all investment profits by 3% per level through compound growth strategies.",
    effect: (l) => `+${formatPercent(l * 3)} profit`,
    path: "bonus", row: 0,
  ...
  },
  {
    ...
    short: "Duration Opt",
    description: "Reduces investment package duration by 2% per level through efficient capital deployment.",
    effect: (l) => `-${formatPercent(l * 2)} time`,
    path: "bonus", row: 1,
  ...
  {
    id: "starting-cash",
    name: "Initial Capital Injection",
    short: "Capital Injection",
    description: "Provides additional starting capital for each new run after prestige, accelerating early growth.",
    effect: (l) => {
  ...
  {
    id: "accel-boost",
    name: "Acceleration Amplification",
    short: "Accel Amp",
    description: "Multiplies acceleration strength by 2x, 3x, and 4x per level for faster investment cycles.",
  ...
  {
    id: "passive-mult",
    name: "Passive Income Enhancement",
    short: "Passive Boost",
    description: "Increases passive yield output by 10% per level through optimized income streams.",
    effect: (l) => `+${formatPercent(l * 10)} passive`,
    path: "bonus", row: 4,
  ...
  },
  {
    ...
    short: "Synergy",
    description: "Increases profit by 3% per additional invested slot through diversified portfolio optimization.",
    effect: (l) => `+${formatPercent(l * 3)} per filled slot`,
    path: "bonus", row: 5,
  ...
  },
  {
    ...
    short: "Analytics",
    description: "Improves market event rewards by 25% and reduces negative event impacts by 20% through data analysis.",
  ...
  },
  {
    ...
    short: "Accel. Compound",
    description: "Increases savings account interest compounding frequency by 50% for faster wealth accumulation.",
  ...
  },
  {
    ...
    name: "Wealth Amplification",
    short: "Wealth Amp",
    description: "Multiplies all profit bonuses by 1.25x through advanced wealth management strategies.",
    effect: () => "1.25× all bonuses",
    path: "bonus", row: 8,
  ...
  },
  {
    ...
    short: "Opportunity",
    description: "Provides a 10% chance to double profits on investment completions through favorable market conditions.",
  ...
  // ─── MONEY METHODS (10 nodes) ──────────────────────────────────
  {
    ...
    short: "Interest Account",
    description: "Generates continuous interest on idle balance at 0.2% per hour per level.",
  ...
  },
  {
    ...
    short: "Gov. Assist",
    description: "Increases bankruptcy stimulus payout to provide stronger recovery options.",
    effect: (l) => {
  ...
  },
  {
    ...
    short: "Dividends",
    description: "Adds a 2% dividend bonus per level to each investment completion.",
    effect: (l) => `+${formatPercent(l * 2)} dividend tip`,
    path: "money", row: 2,
  ...
  {
    id: "business-unlock",
    name: "Business Financing Access",
    short: "Business",
    description: "Unlocks Business Financing investment packages — Small Business Loan, Business Expansion Fund, Commercial Financing.",
    effect: () => "Business packages",
    path: "money", row: 3,
    baseCost: 25, costGrowth: 1, maxLevel: 1,
    prereqs: [{ id: "dividends", level: 2 }], requiredRank: "silver", tint: "#00E5FF",
  },
  {
    id: "diversified-unlock",
    name: "Diversified Portfolio Access",
    short: "Diversified",
    description: "Unlocks Diversified Portfolio investment packages — Credit Portfolio, Diversified Loan Portfolio, International Credit Portfolio.",
    effect: () => "Diversified packages",
    path: "money", row: 4,
    baseCost: 60, costGrowth: 1, maxLevel: 1,
    prereqs: [{ id: "business-unlock", level: 1 }], requiredRank: "gold", tint: "#FFB84D",
  },
  {
    id: "property-unlock",
    name: "Property Investment Access",
    short: "Property",
    description: "Unlocks Property Investment packages — Mortgage Portfolio, Commercial Property Fund, Real Estate Development.",
    effect: () => "Property packages",
    path: "money", row: 5,
    baseCost: 120, costGrowth: 1, maxLevel: 1,
    prereqs: [{ id: "diversified-unlock", level: 1 }], requiredRank: "platinum", tint: "#FFD54F",
  },
  {
    id: "sector-unlock",
    name: "Sector Fund Access",
    short: "Sector",
    description: "Unlocks Sector Fund investment packages — Renewable Energy, Healthcare, Technology Venture, AI Infrastructure.",
    effect: () => "Sector packages",
    path: "money", row: 6,
    baseCost: 200, costGrowth: 1, maxLevel: 1,
    prereqs: [{ id: "property-unlock", level: 1 }], requiredRank: "diamond", tint: "#B9F2FF",
  },
  {
    id: "institutional-unlock",
    name: "Institutional Investment Access",
    short: "Institutional",
    description: "Unlocks Institutional Investment packages — Corporate Bond Portfolio, Private Equity, Institutional Growth Fund, Global Investment Portfolio.",
    effect: () => "Institutional packages",
    path: "money", row: 7,
    baseCost: 350, costGrowth: 1, maxLevel: 1,
    prereqs: [{ id: "sector-unlock", level: 1 }], requiredRank: "diamond", tint: "#FF6EC7",
  },
  {
    id: "premium-unlock",
    name: "Premium P2P Access",
    short: "Premium P2P",
    description: "Unlocks Premium P2P investment packages — P2P MAX 3, 6, 12, 24, and P2P SAFE. The ultimate investment products.",
    effect: () => "Premium P2P packages",
    path: "money", row: 8,
    baseCost: 500, costGrowth: 1, maxLevel: 1,
    prereqs: [{ id: "institutional-unlock", level: 1 }], requiredRank: "legend", tint: "#FFD700",
  },
  {
    id: "banking-network",
    name: "Institutional Access",
    short: "Institutional",
    description: "Reduces investment costs by 10% through institutional banking relationships.",
    effect: () => "10% cheaper investments",
    path: "money", row: 9,
    baseCost: 150, costGrowth: 1, maxLevel: 1,
    prereqs: [{ id: "premium-unlock", level: 1 }], requiredRank: "legend", tint: "#60A5FA",
  },
  {
    id: "investment-fund",
    name: "Hedge Fund Management",
    short: "Hedge Fund",
    description: "Increases passive income by 20% through professional hedge fund strategies.",
    effect: () => "20% more passive",
    path: "money", row: 10,
    baseCost: 250, costGrowth: 1, maxLevel: 1,
  ...
  },
  {
    ...
    short: "Capital Opt",
    description: "Increases all profits by 10% through advanced capital allocation strategies.",
    effect: () => "10% more profit",
    path: "money", row: 11,
    baseCost: 350, costGrowth: 1, maxLevel: 1,
  ...
  // ─── ENDGAME (Legend-only chain in the Money column) ──────────
  {
    ...
    name: "Market Dominance",
    short: "Market Dom",
    description: "Doubles all investment profits through complete market control and dominance.",
    effect: () => "All profits ×2",
    path: "money", row: 12,
  ...
  {
    id: "endgame-costs",
    name: "Cost Efficiency Mastery",
    short: "Cost Mastery",
    description: "Reduces all investment costs by 30% through advanced cost optimization strategies.",
    effect: () => "Pkg costs −30%",
    path: "money", row: 13,
  ...
  {
    id: "endgame-passive",
    name: "Passive Income Maximization",
    short: "Passive Max",
    description: "Triples passive income and savings interest through maximum yield optimization.",
    effect: () => "Passive ×3",
    path: "money", row: 14,
  ...
  },
  {
    ...
    short: "Ultimate",
    description: "Reduces all upgrade costs by 50% through complete system optimization and mastery.",
    effect: () => "Upgrade costs −50%",
    path: "money", row: 15,
...
export type TreeEffects = {
  ...
  // Investment category unlocks
  businessUnlocked: boolean;
  diversifiedUnlocked: boolean;
...
export const deriveTreeEffects = (levels: SkillLevels): TreeEffects => {
  ...
  return {
    profitMult:       1 + 0.03 * lvl(levels, "profit-boost"),
    durationMult:     1 - 0.02 * lvl(levels, "time-cut"),
    passiveMult:      1 + 0.10 * lvl(levels, "passive-mult"),
    ...
    slotSynergyPct:   0.03 * lvl(levels, "slot-power"),
    savingsRatePerSec: (0.002 * lvl(levels, "savings")) / 3600, // 0.2%/hr per level
    dividendPct:      0.02 * lvl(levels, "dividends"),
    ...
    // Investment category unlocks
    businessUnlocked: lvl(levels, "business-unlock") >= 1,
    diversifiedUnlocked: lvl(levels, "diversified-unlock") >= 1,
    propertyUnlocked: lvl(levels, "property-unlock") >= 1,
    sectorUnlocked: lvl(levels, "sector-unlock") >= 1,
    institutionalUnlocked: lvl(levels, "institutional-unlock") >= 1,
    premiumUnlocked: lvl(levels, "premium-unlock") >= 1,
    endgameProfitMult:      lvl(levels, "endgame-profit") >= 1 ? 2 : 1,
    endgameCostMult:        lvl(levels, "endgame-costs") >= 1 ? 0.7 : 1,
    endgamePassiveMult:     lvl(levels, "endgame-passive") >= 1 ? 3 : 1,
    endgameUpgradeCostMult: lvl(levels, "endgame-capstone") >= 1 ? 0.5 : 1,
    endgameComplete:
