...
export const SKILLS: SkillNode[] = [
  ...
  },
  {
    ...
    short: "Contracts",
    description: `Unlocks the Contract package — ${formatCurrency(10000)} stake, 5 min, +${formatPercent(400)} profit.`,
  ...
  },
  {
    ...
    short: "Premium",
    description: `Unlocks the Premium Contract — ${formatCurrency(100000)} stake, 15 min, +${formatPercent(900)} profit.`,
    effect: () => "New package: Premium",
    path: "money", row: 4,
    baseCost: 100, costGrowth: 1, maxLevel: 1,
  ...
  },
  {
    ...
    short: "High-Value",
    description: "Increases Whale Vault base profit by 50% through specialized high-value strategies.",
  ...
  },
  {
    ...
    short: "Premium Opt",
    description: "Doubles Premium Contract profit through advanced optimization techniques.",
    effect: () => `Premium ×2`,
    path: "money", row: 6,
    baseCost: 200, costGrowth: 1, maxLevel: 1,
