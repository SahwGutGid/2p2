...
export const SKILLS: SkillNode[] = [
  ...
  },
  {
    ...
    short: "Batch Process",
    description: "Process multiple investment completions simultaneously, reducing queue delays.",
    effect: () => "Parallel completions",
  ...
  },
  {
    ...
    short: "Algo Trading",
    description: "AI-driven investment decisions optimize package selection based on market conditions.",
    effect: () => "AI optimization",
  ...
  },
  {
    ...
    short: "Quantum",
    description: "Instant processing for certain operations, bypassing normal timing constraints.",
    effect: () => "Instant operations",
  ...
  },
  {
    ...
    short: "Autonomous",
    description: "Self-managing investment portfolio that automatically rebalances and optimizes holdings.",
    effect: () => "Self-managing",
  ...
  },
  {
    ...
    description: "Increased awareness of market events, improving event rewards and reducing negative impacts.",
    effect: () => "Better events",
    path: "bonus", row: 6,
    baseCost: 40, costGrowth: 1, maxLevel: 1,
  ...
  },
  {
    ...
    description: "Savings account interest compounds more frequently, accelerating wealth accumulation.",
    effect: () => "Faster compounding",
    path: "bonus", row: 7,
    baseCost: 60, costGrowth: 1, maxLevel: 1,
  ...
  },
  {
    ...
    short: "Wealth Mult",
    description: "All profit bonuses are multiplied by 1.5x, dramatically increasing overall earnings.",
  ...
  },
  {
    ...
    short: "Fortune",
    description: "Random chance to double profits on investment completions, bringing unexpected windfalls.",
    effect: () => "Random 2× profit",
    path: "bonus", row: 9,
  ...
  },
  {
    ...
    short: "Banking Net",
    description: "Access to international banking systems reduces transaction costs and improves capital flow.",
  ...
  },
  {
    ...
    short: "Hedge Fund",
    description: "Sophisticated investment strategies generate additional passive income from all holdings.",
    effect: () => "Extra passive income",
    path: "money", row: 8,
    baseCost: 250, costGrowth: 1, maxLevel: 1,
  ...
  },
  {
    ...
    description: "Mastery over capital markets enables maximum efficiency from all financial operations.",
